 ...
 * @author baoha
 */
public class PolyQLND extends javax.swing.JFrame implements QuanLyNguoiDungctr{
    NguoiDungDAO dao =new  NguoiDungimpl();
    List<NguoiDung> items = new ArrayList<>();
    /**
     * Creates new form PolyQLND
     */
    public PolyQLND() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setBackground(new java.awt.Color(78, 179, 254));
        ...
        tblUser.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Mã Người Dùng", "Tên Người Dùng", "Mật Khẩu", "Chức Vụ", "Mã nhân viên"
            }
        ));
        ...
        lbl.setFont(new java.awt.Font("Segoe UI Black", 0, 18)); // NOI18N
        lbl.setForeground(new java.awt.Color(255, 255, 255));
        lbl.setText("Mã nhân viên");
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                ...
                                .addComponent(txtTen, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 380, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addComponent(txtPass, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 380, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addComponent(txtChucvu, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 380, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                                    .addComponent(jLabel7)
                                    .addGap(228, 228, 228))
                                .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(txtNhanvien, javax.swing.GroupLayout.PREFERRED_SIZE, 380, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addComponent(lbl)))
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PolyQLND.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    public void setForm(NguoiDung entity) {
        txtMa.setText(entity.getMaND());
        txtTen.setText(entity.getTenND());
        txtPass.setText(entity.getMatKhau());
        txtChucvu.setText(entity.getChucVu());
        txtNhanvien.setText(entity.getMaNV());
    }

    @Override
    public NguoiDung getForm() {
        NguoiDung entity = new NguoiDung();
        entity.setMaND(txtMa.getText());
        entity.setChucVu(txtChucvu.getText());
        entity.setTenND(txtTen.getText());
        entity.setMatKhau(txtPass.getText());
        entity.setMaNV(txtNhanvien.getText());
        return entity;
    }
    ...
    @Override
    public void edit() {
        NguoiDung entity = items.get(tblUser.getSelectedRow());
        this.setForm(entity);
