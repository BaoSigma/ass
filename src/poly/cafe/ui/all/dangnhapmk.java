 ...
 * @author Admin
 */
public class dangnhapmk extends javax.swing.JFrame {

    /**
     * Creates new form dangnhapmk
     */
    public dangnhapmk() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(dangnhapmk.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new dangnhapmk().setVisible(true);
            }
        });
    }
